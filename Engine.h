...
void RunCommand(Environment *env, UDFContext *context, UDFValue *ret);
void SetBreakCommand(Environment *env, UDFContext *context, UDFValue *ret);
void RemoveBreakCommand(Environment *env, UDFContext *context, UDFValue *ret);
void ShowBreaksCommand(Environment *env, UDFContext *context, UDFValue *ret);
void HaltCommand(Environment *env, UDFContext *context, UDFValue *ret);
void FocusCommand(Environment *env, UDFContext *context, UDFValue *ret);
void ClearFocusStackCommand(Environment *env, UDFContext *context, UDFValue *ret);
...
void ListFocusStackCommand(Environment *env, UDFContext *context, UDFValue *ret);
void ListFocusStack(Environment *, const char *);
void GetFocusStackFunction(Environment *env, UDFContext *context, UDFValue *ret);
void GetFocusStack(Environment *, CLIPSValue *);
void PopFocusFunction(Environment *env, UDFContext *context, UDFValue *ret);
