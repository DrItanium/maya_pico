...
void ModifyCommand(Environment *env, UDFContext *context, UDFValue *ret);
void DuplicateCommand(Environment *env, UDFContext *context, UDFValue *ret);
void DeftemplateSlotNamesFunction(Environment *env, UDFContext *context, UDFValue *ret);
void DeftemplateSlotNames(Deftemplate *, CLIPSValue *);
void DeftemplateSlotDefaultValueFunction(Environment *env, UDFContext *context, UDFValue *ret);
bool DeftemplateSlotDefaultValue(Deftemplate *, const char *, CLIPSValue *);
void DeftemplateSlotCardinalityFunction(Environment *env, UDFContext *context, UDFValue *ret);
bool DeftemplateSlotCardinality(Deftemplate *, const char *, CLIPSValue *);
void DeftemplateSlotAllowedValuesFunction(Environment *env, UDFContext *context, UDFValue *ret);
bool DeftemplateSlotAllowedValues(Deftemplate *, const char *, CLIPSValue *);
void DeftemplateSlotRangeFunction(Environment *env, UDFContext *context, UDFValue *ret);
bool DeftemplateSlotRange(Deftemplate *, const char *, CLIPSValue *);
void DeftemplateSlotTypesFunction(Environment *env, UDFContext *context, UDFValue *ret);
bool DeftemplateSlotTypes(Deftemplate *, const char *, CLIPSValue *);
void DeftemplateSlotMultiPFunction(Environment *env, UDFContext *context, UDFValue *ret);
bool DeftemplateSlotMultiP(Deftemplate *, const char *);
void DeftemplateSlotSinglePFunction(Environment *env, UDFContext *context, UDFValue *ret);
bool DeftemplateSlotSingleP(Deftemplate *, const char *);
void DeftemplateSlotExistPFunction(Environment *env, UDFContext *context, UDFValue *ret);
bool DeftemplateSlotExistP(Deftemplate *, const char *);
void DeftemplateSlotDefaultPFunction(Environment *env, UDFContext *context, UDFValue *ret);
DefaultType DeftemplateSlotDefaultP(Deftemplate *, const char *);
void DeftemplateSlotFacetExistPFunction(Environment *env, UDFContext *context, UDFValue *ret);
bool DeftemplateSlotFacetExistP(Environment *, Deftemplate *, const char *, const char *);
void DeftemplateSlotFacetValueFunction(Environment *env, UDFContext *context, UDFValue *ret);
