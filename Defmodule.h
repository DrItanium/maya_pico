...
void GetCurrentModuleCommand(Environment *env, UDFContext *context, UDFValue *ret);
void SetCurrentModuleCommand(Environment *env, UDFContext *context, UDFValue *ret);
