...
void UndefgenericCommand(Environment *env, UDFContext *context, UDFValue *ret);
void GetDefgenericModuleCommand(Environment *env, UDFContext *context, UDFValue *ret);
void UndefmethodCommand(Environment *env, UDFContext *context, UDFValue *ret);
...
void PPDefgenericCommand(Environment *env, UDFContext *context, UDFValue *ret);
void PPDefmethodCommand(Environment *env, UDFContext *context, UDFValue *ret);
void ListDefmethodsCommand(Environment *env, UDFContext *context, UDFValue *ret);
const char *DefmethodPPForm(Defgeneric *, unsigned short);
void ListDefgenericsCommand(Environment *env, UDFContext *context, UDFValue *ret);
void ListDefgenerics(Environment *, const char *, Defmodule *);
void ListDefmethods(Environment *, const char *, Defgeneric *);
#endif
void GetDefgenericListFunction(Environment *env, UDFContext *context, UDFValue *ret);
void GetDefgenericList(Environment *, CLIPSValue *, Defmodule *);
void GetDefmethodListCommand(Environment *env, UDFContext *context, UDFValue *ret);
void GetDefmethodList(Environment *, CLIPSValue *, Defgeneric *);
void GetMethodRestrictionsCommand(Environment *env, UDFContext *context, UDFValue *ret);
